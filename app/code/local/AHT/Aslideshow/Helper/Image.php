...
class AHT_Aslideshow_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
     ...
     *
     * @see AHT_Aslideshow_Model_Slideshow_Image
     * @param int $width
     * @param int $height
     * @return AHT_Aslideshow_Helper_Image
     */
     ...
     * Enter description here...
     *
     * @return AHT_Aslideshow_Model_Slideshow_Image
     */
