 ...
 */
class AHT_Aslideshow_Block_Adminhtml_Slideshow_Edit_Tab_Ajax_Serializer extends Mage_Core_Block_Template
{
    public function _construct()
    {
        parent::_construct();
        $this->setTemplate('aht_aslideshow/edit/serializer.phtml');
        return $this;
    }
